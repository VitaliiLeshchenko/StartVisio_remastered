SELECT SUM(bl) bl,
  ...
  FROM (SELECT DISTINCT th.task_id,
          ...
          JOIN item_master im ON im.sku_id = td.sku_id AND im.cd_master_id NOT IN ('3003', '9005', '9006', '11005', '18004', '10003', '20004')
          JOIN pkt_hdr ph ON ph.pkt_ctrl_nbr = td.pkt_ctrl_nbr
          JOIN pkt_hdr_intrnl phi ON phi.pkt_ctrl_nbr = ph.pkt_ctrl_nbr
         WHERE th.begin_area = 'IVS' AND th.stat_code < '90')
 GROUP BY dep
 ORDER BY 3
